...
- `mWeed` - `PENDIENTE` - script de cultivo (categoria `[qb]`).
...
3. `luxu_admin`
4. `origen_police`
5. `jg-mechanic-props` + `jg-vehiclemileage` + `jg-mechanic` (como pack)
6. `3fe_woodbox` + `0r-illegalpack` (pack)
7. `cfx-nteam-paletomechanic`
8. `sc_c_island`
