...
function Utils.Vehicles.setVehicleProperties(vehicle, props)
	...
	if props.color1 then
		...
		if type(props.color1) == 'table' then
			...
			SetVehicleColours(vehicle, tonumber(props.color1) or colorPrimary, colorSecondary)
		end
	...
	if props.color2 then
		...
		if type(props.color2) == 'table' then
			...
			SetVehicleColours(vehicle, colorPrimary, tonumber(props.color2) or colorSecondary)
		end
	...
	if props.extras then
		...
		for id, disable in pairs(props.extras) do
			...
			SetVehicleExtra(vehicle, tonumber(id), disable ~= 0)
		end
