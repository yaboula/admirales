...
Config.max_stores_per_player = 1
Config.max_stores_employed = 2
Config.has_stock_when_unowed = true
Config.max_jobs = 20
Config.disable_rename_business = false
Config.group_map_blips = true
Config.charge_import_money_before = true
Config.market_locations = {

	["market_1"] = {
		['buy_price'] = 220000,
		['sell_price'] = 110000,
		['coord'] = {-709.57440185547,-905.78985595703,19.215585708618},
		['garage_coord'] = {-707.13,-924.98,19.02,179.01},
		['truck_parking_location'] = {-707.95, -929.8, 19.01, 180.0},
		['map_blip_coord'] = {-714.77,-912.22,19.21},
		['sell_blip_coords'] = {
		...
		['deliveryman_coord'] = {-714.55,-917.8,19.22},
		['type'] = '247store',
		['account'] = {
			['item'] = {
				[1] = {
...
Config.market_categories = {
	...
	['alcohol_market'] = {
		...
		['page_icon'] = '<img src="img/categories/alcohol-icon.png" style="padding:15px">',
		['page_img'] = 'img/categories/alcohol.png',
		['category_buy_price'] = 2500,
		['category_sell_price'] = 1250,
		['items'] = {
...
Config.clear_stores = {
	...
	-- [INST INST-019] Disabled to avoid legacy-record nil errors during startup cleanup thread.
	['active'] = false,
	['min_stock_amount'] = 30,
	['min_stock_variety'] = 70,
	['cooldown'] = 72
}
...
Config.NPCs = {

	{
		...
		['emote'] = 'WORLD_HUMAN_STAND_MOBILE',
		['pos'] = {
