...
Translations = {
    ...
    ['objects'] = {
        ...
        ['prev'] = 'Objeto anterior',
        ['next'] = 'Siguiente objeto',
        ['cancel'] = 'Cancelar',
    ...
    ['ReportsEms'] = 'INFORMES CLÍNICOS',

    ['ReportEms'] = 'INFORME CLÍNICO',

    ['ReportNameEms'] = 'NOMBRE DEL INFORME',

    ['ReportIdEms'] = 'ID DEL INFORME',

    ['ReportDescEms'] = 'ANAMNESIS Y EXÁMEN FÍSICO',

    ['ReportEvidencesEms'] = 'TRATAMIENTOS',

    ['AddReportEvidenceEms'] = 'AÑADIR TRATAMIENTO',

    ['ReportPeopleEms'] = 'PACIENTES AFECTADOS',

    ['ReportAddPeopleEms'] = 'AÑADIR PACIENTE',

    ['ReportAgentsEms'] = 'MÉDICOS INVOLUCRADOS',

    ['ReportAddAgentEms'] = 'AÑADIR MÉDICO',

    ['ReportVictimsEms'] = 'PRONÓSTICO',

    ['ReportDeleteEms'] = 'ELIMINAR INFORME',

    ['ReportBillsEms'] = 'FACTURAS MÉDICAS',

    ['AddReportBillEms'] = 'AÑADIR FACTURA',

    ['ReportListEms'] = 'LISTA DE INFORMES',

    ['SearchReportEms'] = 'Buscar un informe médico...',

    ['NewReportEms'] = 'NUEVO INFORME',

    ['SelectReportEms'] = 'SELECCIONA UN INFORME PARA CARGAR LA INFORMACIÓN',

    ['AgentInChargeEms'] = 'MÉDICO A CARGO',

    ['EnterReportDescEms'] = 'Introduce la descripción del informe médico',

    ['DestroyReportEms'] = 'ELIMINAR INFORME'
