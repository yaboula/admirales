...
Translations = {
    ...
    ['ReportsEms'] = 'RAPPORTS CLINIQUES',

    ['ReportEms'] = 'RAPPORT CLINIQUE',

    ['ReportNameEms'] = 'NOM DU RAPPORT',

    ['ReportIdEms'] = 'ID DU RAPPORT',

    ['ReportDescEms'] = 'ANAMNÈSE ET EXAMEN PHYSIQUE',

    ['ReportEvidencesEms'] = 'TRAITEMENTS',

    ['AddReportEvidenceEms'] = 'AJOUTER UN TRAITEMENT',

    ['ReportPeopleEms'] = 'PATIENTS CONCERNÉS',

    ['ReportAddPeopleEms'] = 'AJOUTER UN PATIENT',

    ['ReportAgentsEms'] = 'MÉDECINS IMPLIQUÉS',

    ['ReportAddAgentEms'] = 'AJOUTER UN MÉDECIN',

    ['ReportVictimsEms'] = 'PRONOSTIC',

    ['ReportDeleteEms'] = 'SUPPRIMER LE RAPPORT',

    ['ReportBillsEms'] = 'FACTURES MÉDICALES',

    ['AddReportBillEms'] = 'AJOUTER UNE FACTURE',

    ['ReportListEms'] = 'LISTE DES RAPPORTS',

    ['SearchReportEms'] = 'Rechercher un rapport médical...',

    ['NewReportEms'] = 'NOUVEAU RAPPORT',

    ['SelectReportEms'] = 'SÉLECTIONNER UN RAPPORT POUR CHARGER LES INFORMATIONS',

    ['AgentInChargeEms'] = 'MÉDECIN RESPONSABLE',

    ['EnterReportDescEms'] = 'Saisir la description du rapport médical',

    ['DestroyReportEms'] = 'SUPPRIMER LE RAPPORT'
