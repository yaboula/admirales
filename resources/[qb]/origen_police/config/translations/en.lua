...
Translations = {
    ...
    ['ReportsEms'] = 'CLINICAL REPORTS',

    ['ReportEms'] = 'CLINICAL REPORT',

    ['ReportNameEms'] = 'REPORT NAME',

    ['ReportIdEms'] = 'REPORT ID',

    ['ReportDescEms'] = 'MEDICAL HISTORY AND PHYSICAL EXAM',

    ['ReportEvidencesEms'] = 'TREATMENTS',

    ['AddReportEvidenceEms'] = 'ADD TREATMENT',

    ['ReportPeopleEms'] = 'AFFECTED PATIENTS',

    ['ReportAddPeopleEms'] = 'ADD PATIENT',

    ['ReportAgentsEms'] = 'INVOLVED DOCTORS',

    ['ReportAddAgentEms'] = 'ADD DOCTOR',

    ['ReportVictimsEms'] = 'PROGNOSIS',

    ['ReportDeleteEms'] = 'DELETE REPORT',

    ['ReportBillsEms'] = 'MEDICAL BILLS',

    ['AddReportBillEms'] = 'ADD BILL',

    ['ReportListEms'] = 'REPORTS LIST',

    ['SearchReportEms'] = 'Search a medical report...',

    ['NewReportEms'] = 'NEW REPORT',

    ['SelectReportEms'] = 'SELECT A REPORT TO LOAD INFORMATION',

    ['AgentInChargeEms'] = 'DOCTOR IN CHARGE',

    ['EnterReportDescEms'] = 'Enter the medical report description',

    ['DestroyReportEms'] = 'DELETE REPORT'
