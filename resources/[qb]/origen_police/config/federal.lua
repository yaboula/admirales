...
Config.DefaultExit = "Boling Broke"
Config.TimePerMonth = 60
Config.OwnPrisionSystem = false
Config.BusModel = "pbus"

Config.PedWalkOnAnim = true
Config.ForcedExit = {
    enabled = false,
...
if not Config.Federal.Exits[Config.DefaultExit] then

    print("Default exit not found in Config.Federal.Exits: ", Config.DefaultExit)
