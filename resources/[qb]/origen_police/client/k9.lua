    ...
    while true do
      ...
      if not L2_3 then
        ...
        if not L2_3 then
          ...
          -- [INST INST-028 RAC-002] 'goto lbl_118' reemplazado (label en scope inválido).
          -- Inline del bloque lbl_118 (hide help) + salto a ::lbl_123:: que SÍ es visible.
          if L0_3 then
      ...
      elseif L0_3 then
        ...
        -- [INST INST-028 RAC-002] ::lbl_118:: eliminado (era dead code tras mover el goto).
        L5_3 = HideHelpNotification
...
function L4_1()
  ...
  -- [INST INST-028][RAC-007] /k9 y la tecla K solo abrían el menú si el perro ya
  -- existía (L0_1 ~= 0). El flujo normal del ítem "k9" es CallK9 primero (cerca
  -- del vehículo K9). Reutilizamos el mismo evento cuando aún no hay perro.
  L0_2 = L0_1
  ...
  if 0 == L0_2 then
    ...
    L1_2 = "origen_police:client:CallK9"
